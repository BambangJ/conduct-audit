                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="audit_plan_no" name="audit_plan_no" value="2024-IA-01" class="form-control" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="audit_type">Jenis Audit:</label>
                            <input type="text" id="audit_type" name="audit_type" value="Initial Audit" class="form-control" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="subject" name="subject" value="Internal Audit Airbus Helicopter" class="form-control" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="date_of_audit">Tanggal Audit:</label>
                            <input type="date" id="date_of_audit" name="date_of_audit" value="2024-12-12" class="form-control" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="area_manager">Area Manager:</label>
                            <input type="text" id="area_manager" name="area_manager" value="Ilham Kurnia" class="form-control" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="concurrence">Konkurensi:</label>
                            <input type="text" id="concurrence" name="concurrence" value="Dwi Haryono" class="form-control" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="process">Process/Area/Dept:</label>
                            <input type="text" id="process" name="process" value="Dwi Haryono" class="form-control" readonly>
                        </div>
                    </div>
                </div>
            </div>
